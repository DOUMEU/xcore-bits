import componentCode from "../../components/components/GlassIcons.jsx?raw";
import cssCode from "../../components/components/GlassIcons.css?raw";

const installCommands = {
  pnpm: "pnpm dlx shadcn@latest add @react-bits/GlassIcons-JS-CSS",
  npm: "npx shadcn@latest add @react-bits/GlassIcons-JS-CSS",
  yarn: "yarn dlx shadcn@latest add @react-bits/GlassIcons-JS-CSS",
  bun: "bunx shadcn@latest add @react-bits/GlassIcons-JS-CSS",
};
